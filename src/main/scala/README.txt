...
java -jar mutseq.jar <action> <conf_file> <file to parse>
...
java -jar mutseq.jar parsefq ZAP70.conf lib1.fastq.gz
...
java -jar mutseq.jar extractmut ZAP70.conf lib2.fastq
